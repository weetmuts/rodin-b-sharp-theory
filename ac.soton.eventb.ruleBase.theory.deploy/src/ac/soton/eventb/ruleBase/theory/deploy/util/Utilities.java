package ac.soton.eventb.ruleBase.theory.deploy.util;
...
public class Utilities {
	...
	public static void log(Throwable exc, String message) {
		...
		IStatus status = new Status(IStatus.ERROR, TheoryDeployPlugIn.PLUGIN_ID,
				IStatus.ERROR, message, exc);
		TheoryDeployPlugIn.getPlugin().getLog().log(status);
	}

...
public class TheoryTransformer extends
		DefinitionTransformer<IFormulaExtensionsSource> {
	...
	protected ISCNewOperatorDefinition[] getOperators(
			IFormulaExtensionsSource source) throws CoreException {
		return source.getSCNewOperatorDefinitions();
	}

	protected ISCDatatypeDefinition[] getDatatypes(
			IFormulaExtensionsSource source) throws CoreException {
		return source.getSCDatatypeDefinitions();
	}

	protected ISCTypeParameter[] getTypeParameters(
			IFormulaExtensionsSource source) throws CoreException {

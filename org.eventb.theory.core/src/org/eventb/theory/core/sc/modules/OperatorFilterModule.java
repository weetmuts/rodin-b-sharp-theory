...
public class OperatorFilterModule extends SCFilterModule{
	...
	private final IModuleType<OperatorFilterModule> MODULE_TYPE = 
			SCCore.getModuleType(TheoryPlugin.PLUGIN_ID + ".operatorFilterModule");
	...
	public boolean accept(IRodinElement element, ISCStateRepository repository,
		...
		OperatorLabelSymbolTable labelSymbolTable = (OperatorLabelSymbolTable) repository.getState(OperatorLabelSymbolTable.STATE_TYPE);

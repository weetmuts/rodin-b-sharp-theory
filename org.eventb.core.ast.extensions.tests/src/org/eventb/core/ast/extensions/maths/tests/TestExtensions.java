...
public class TestExtensions extends BasicAstExtTest{
	...
	public void testExtensions_013_Parsing() throws Exception{
		new ParsingTest( array(listSizeExtension()) , makeSList("cons(x0,l0)", "listSize(l0)", "listSize(nil)", "listSize(cons(x,l0))"), 
				makeSList("listSize", "listSize()", "listSize(nil, nil)"), false ).test();
	}
	
	public void testExtensions_014_Parsing() throws Exception{
		new ParsingTest( array(oppositeExtension()) , makeSList("opposite(d)", "opposite(NORTH)", "opposite(SOUTH)"), 
	...
	public void testExtensions_015_TC() throws CoreException{
		new TCTest(array(primeExtension()), makeSList("prime(2)", "prime(0)", "prime(-1)", "prime(x+y)"), makeSList("prime(BOOL)", "prime({1,2})", "prime(TRUE)"), makeSList(), makeSList("x", "y"), makeSList("ℤ", "ℤ"));
	}
	
	public void testExtensions_016_TC() throws CoreException{
		new TCTest(array(sameSizeExtension()), makeSList("sameSize({1,2}, {TRUE, FALSE})", "sameSize(ℕ, BOOL)", "sameSize(s, BOOL)", "sameSize(s, t)"), 
	...
	public void testExtensions_017_TC() throws CoreException{
		new TCTest(array(isEmptySeqExtension()), makeSList("isEmpty(s)", "isEmpty(∅⦂ℤ↔S)", "isEmpty({1↦a})"), makeSList("isEmpty(∅)", "isEmpty({1})"), makeSList("S"), makeSList("s", "a"), makeSList("ℤ↔S", "S")).test();
	}
	
	public void testExtensions_018_TC() throws CoreException{
		new TCTest(array(seqExtension()), makeSList("seq(BOOL)", "seq({1,2,3})", "seq({1↦2})", "{1↦2} ∈ seq(ℤ)"), makeSList("seq(∅)", "seq(0)"), makeSList(), makeSList(), makeSList()).test();
	}
	
	public void testExtensions_019_TC() throws CoreException{
		new TCTest(array(seqSizeExtension()), makeSList("seqSize(s) = n", "seqSize({1↦2})", "seqSize(∅⦂ℤ↔S)"), makeSList("seqSize({1})", "seqSize(∅)"), 
				makeSList("S"), makeSList("s", "n"), makeSList("ℤ↔S", "ℤ")).test();
	}
	
	public void testExtensions_020_TC() throws CoreException{
		new TCTest(array(seqTailExtension()), makeSList("seqTail(s)=s", "seqTail(∅⦂ℤ↔S)", "seqTail({1↦2})"), makeSList("seqTail(∅)", "seqTail(S)"), 
				makeSList("S"), makeSList("s"), makeSList("ℤ↔S")).test();
	}
	
	public void testExtensions_021_TC() throws CoreException{
		new TCTest(array(seqHeadExtension()), makeSList("seqHead(s) = e", "seqHead(∅⦂ℤ↔S)", "seqHead({1↦2})"), makeSList("seqHead(∅)", "seqHead(S)"), 
				makeSList("S"), makeSList("s", "e"), makeSList("ℤ↔S", "S")).test();
	}
	
	public void testExtensions_022_TC() throws CoreException{
		new TCTest(array(andExtension()), makeSList("a AND b", "a AND b AND c", "(TRUE AND FALSE)= FALSE"), makeSList("0 AND 1", "TRUE AND BOOL"),
				makeSList(), makeSList("a", "b", "c"), makeSList("BOOL", "BOOL","BOOL")).test();
	}
	
	public void testExtensions_023_TC() throws CoreException{
		new TCTest(array(orExtension()), makeSList("a OR b", "a OR b OR c", "(TRUE OR FALSE)= FALSE"), makeSList("0 OR 1", "TRUE OR BOOL"),
				makeSList(), makeSList("a", "b", "c"), makeSList("BOOL", "BOOL","BOOL")).test();
	}
	
	public void testExtensions_024_TC() throws CoreException{
		new TCTest(array(seqConcatExtension()), makeSList("s1 seqConcat s1", "(s1 seqConcat s2) = s3", "s1 seqConcat s2 seqConcat ∅"), makeSList("{1} seqConcat ∅"),
	...
	public void testExtensions_027_TC() throws CoreException{
		new TCTest(array(listSizeExtension()), makeSList("listSize(cons(x, l))", "listSize(cons(x, l)) = 1", "listSize(nil⦂List(S))=0"),
	...
	public void testExtensions_028_TC() throws CoreException{
		new TCTest(array(oppositeExtension()), makeSList("opposite(NORTH)", "opposite(SOUTH)", "opposite(EAST)","opposite(WEST)"),
				makeSList(), makeSList(), makeSList(), makeSList());
	}
	...
	public void testExtensions_029_WD() throws Exception{
		new WDTest(array(primeExtension()),
	...
	public void testExtensions_030_WD() throws Exception{
		new WDTest(array(sameSizeExtension()),
	...
	public void testExtensions_032_WD() throws Exception{
		new WDTest(array(seqSizeExtension()),
	...
	public void testExtensions_033_WD() throws Exception{
		new WDTest(array(isEmptySeqExtension()),
	...
	public void testExtensions_034_WD() throws Exception{
		new WDTest(array(seqTailExtension()),
	...
	public void testExtensions_035_WD() throws Exception{
		new WDTest(array(seqHeadExtension()),
	...
	public void testExtensions_038_WD() throws Exception{
		new WDTest(array(seqConcatExtension()),

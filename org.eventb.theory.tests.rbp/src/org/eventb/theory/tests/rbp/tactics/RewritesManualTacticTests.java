...
public class RewritesManualTacticTests extends AbstractTacticTests {
	 ...
	 * {@link #createTestDefinitions()}.
	 *
	 * @param theorem                 the definition of the theorem to use for the
	 *                                test
	 * @param hypothesis              if {@code true}, the test will use the first
	 *                                hypothesis of the theorem, otherwise the test
	 *                                will use the goal
	 * @param testTheoremInSameTheory if {@code true}, the test theorem is put in
	 *                                the same theory as the definitions, otherwise
	 *                                it is in a different theory
	 * @param expectedSequents        the lists of sequents obtained after applying
	 *                                each application generated by the tactic
	 *                                provider
	 * @see AbstractTacticTests#checkTacticsApplication(String, String, boolean,
	 *      String[]...)
	 */
	protected void testTheorem(String theorem, boolean hypothesis, boolean testTheoremInSameTheory,
			String[]... expectedSequents) throws Exception {
	...
	protected void testTheorem(String theorem, boolean hypothesis, String[]... expectedSequents) throws Exception {
		testTheorem(theorem, hypothesis, false, expectedSequents);
	}
	...
	public void test_operatorDefinitionRewrite_argumentTypeConflict() throws Exception {
		testTheorem("ident2(0↦0)=ident(0)↦ident(0)", false, true, //

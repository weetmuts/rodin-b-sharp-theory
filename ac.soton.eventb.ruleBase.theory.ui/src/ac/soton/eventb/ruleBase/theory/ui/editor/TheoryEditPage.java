 ...
 *     University of Southampton - Customisation for theory files
 *******************************************************************************/
...
import org.eventb.internal.ui.eventbeditor.editpage.DescRegistryReader;
 ...
 * <p> The only change is to {@link TheoryEditPage.createDeclaration()}.</p>
 * 
 * @author maamria
 */
...
public class TheoryEditPage extends EditPage implements
	...
	private void createDeclaration(Composite parent) {
		...
		String declaration = "";
		if (rodinInput instanceof ITheoryRoot)
			declaration = "THEORY";

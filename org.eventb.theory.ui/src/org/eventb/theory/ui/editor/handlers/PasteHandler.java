 ...
 *******************************************************************************/
package org.eventb.theory.ui.editor.handlers;
...
public class PasteHandler extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent arg0) throws ExecutionException {
		...
		IWorkbenchPage activePage = TheoryUIPlugIn.getActivePage();
	...
	private IInternalElement getRodinInput() {
		IEditorPart editor = TheoryUIPlugIn.getActivePage().getActiveEditor();

...
/**
 * Command handler to build a wizard for creating a new theory.
 *
 * @author Guillaume Verdier
 */
public class NewTheoryHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		final NewTheoryWizard wizard = new NewTheoryWizard();
